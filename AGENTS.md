# Agent Instructions for Farmbrain

## Project Context
Farmbrain is an open source Crop advisory and soil analysis AI for Indian agriculture.

## Repository Layout
- `src/aumai_farmbrain/` — package source
